...
Go rewrite of the self-hosted infrastructure CLI and monitoring daemon. Replaces
the Bun + NestJS + Commander + Ink (React) implementation under `../cli/` with a
single static binary and a native (non-Docker) daemon.
